"""Tests for exp0B coefficient-comparison metrics.

The heart of exp0B: on a FIXED tanh geometry, the QI and lstsq readouts solve
...
sys.path.insert(0, str(REPO_ROOT / "experiments" / "exp0B_coeff_diff"))
