...
% Override \BandwidthFigurePath before input if the figure is stored elsewhere.
\providecommand{\qeqref}[1]{(\ref{#1})}
\providecommand{\BandwidthFigurePath}{figures/bandwidth_appendix_figure.pdf}
...
\qeqref{eq:corrected-decomp}. We retain the geometry
...
$e^{-\pi^2/\lambda}$, as in \qeqref{eq:Pbound}.
...
\subsubsection{Width dependence and induced slopes}
