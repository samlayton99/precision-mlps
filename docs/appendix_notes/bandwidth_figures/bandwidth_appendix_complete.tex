...
\subsubsection{The general rule and its tanh default}
...
\subsubsection{Why the kernel ratio appears}
...
\subsubsection{The frequency-dependent refinement}
...
\subsubsection{Inputs and evaluation of the figures}
