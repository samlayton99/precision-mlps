...
Usage:
    python3 experiments/exp03_qi_vs_lstsq/run.py           # collect + plot
    python3 experiments/exp03_qi_vs_lstsq/run.py --plot     # plot only
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "exp03_qi_vs_lstsq"
