...
Usage:
    python experiments/exp08_sampling_and_noise/run.py            # collect + plot
    python experiments/exp08_sampling_and_noise/run.py --plot     # plot from saved data
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "exp08_sampling_and_noise"
