...
Outputs saved to results/exp02_lambda_tradeoff/.

Usage:
    python experiments/exp02_lambda_tradeoff/run.py                # fp64 collect + plot
    python experiments/exp02_lambda_tradeoff/run.py --mpmath       # mpmath collect + plot
    python experiments/exp02_lambda_tradeoff/run.py --plot         # plot fp64 data
    python experiments/exp02_lambda_tradeoff/run.py --mpmath --plot # plot mpmath data
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "exp02_lambda_tradeoff"
