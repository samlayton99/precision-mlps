...
Usage:
    python3 experiments/expC02_lambda_vs_frequency/run.py            # collect + plot
    python3 experiments/expC02_lambda_vs_frequency/run.py --plot      # plot only
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "checkpoint_C_geometry" / "expC02_lambda_vs_frequency"
