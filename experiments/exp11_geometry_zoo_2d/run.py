...
Usage:
    python experiments/exp11_geometry_zoo_2d/run.py            # collect + plot
    python experiments/exp11_geometry_zoo_2d/run.py --plot     # plot from saved data
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "exp11_geometry_zoo_2d"
