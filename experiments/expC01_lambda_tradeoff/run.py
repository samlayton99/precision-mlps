...
Outputs saved to results/checkpoint_C_geometry/expC01_lambda_tradeoff/.

Usage:
    python experiments/expC01_lambda_tradeoff/run.py                # fp64 collect + plot
    python experiments/expC01_lambda_tradeoff/run.py --mpmath       # mpmath collect + plot
    python experiments/expC01_lambda_tradeoff/run.py --plot         # plot fp64 data
    python experiments/expC01_lambda_tradeoff/run.py --mpmath --plot # plot mpmath data
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "checkpoint_C_geometry" / "expC01_lambda_tradeoff"
...
FP64_DATA_PATH = RESULTS_DIR / "data.json"   # coarse fp64 sweep (QI + lstsq)
