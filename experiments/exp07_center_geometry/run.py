...
Usage:
    python experiments/exp07_center_geometry/run.py            # collect + plot
    python experiments/exp07_center_geometry/run.py --plot     # plot from saved data
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "exp07_center_geometry"
