...
Usage:
    python3 experiments/expA02_qi_vs_lstsq/run.py           # collect + plot
    python3 experiments/expA02_qi_vs_lstsq/run.py --plot     # plot only
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "checkpoint_A_numerics" / "expA02_qi_vs_lstsq"
