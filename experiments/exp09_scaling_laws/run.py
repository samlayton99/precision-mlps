...
Usage:
    python experiments/exp09_scaling_laws/run.py            # collect + plot
    python experiments/exp09_scaling_laws/run.py --plot     # plot from saved data
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "exp09_scaling_laws"
