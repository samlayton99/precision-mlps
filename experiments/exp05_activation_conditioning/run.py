...
Usage:
    python3 experiments/exp05_activation_conditioning/run.py            # collect + plot
    python3 experiments/exp05_activation_conditioning/run.py --plot      # plot only
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "exp05_activation_conditioning"
