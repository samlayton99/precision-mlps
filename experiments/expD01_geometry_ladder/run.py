...
Usage:
    python experiments/expD01_geometry_ladder/run.py            # collect + plot
    python experiments/expD01_geometry_ladder/run.py --plot     # plot from saved data
"""
...
RESULTS_DIR = REPO_ROOT / "results" / "checkpoint_D_optimizers" / "expD01_geometry_ladder"
