...
Run: uv run --extra dev python experiments/expC07_lambda_energy_rule/lambda_rule/anchor_v1_prereg.py --predict
     uv run --extra dev python experiments/expC07_lambda_energy_rule/lambda_rule/anchor_v1_prereg.py --run
"""
...
def run():
    ...
    sp = importlib.util.spec_from_file_location("c9", HERE / "run_c09_general.py"); c9 = importlib.util.module_from_spec(sp); sp.loader.exec_module(c9)
